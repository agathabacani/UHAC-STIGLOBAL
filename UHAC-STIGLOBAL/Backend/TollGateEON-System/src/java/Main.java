       ...
       try{
           ...
           +"</div></div>"  
            ...
            +"<div id='headBar'>"
                    ...
                    + "<input type='text' value='TG-02 (Manual Mode)' id='adminpanel'></div>"
            +"</form>");
...
"        </form>\n");
            out.print("<label style='display:"+transactServ.disp+";font-size:40px;color:Green;top:360px;left:330px;position:absolute;'>Payment Successful! Gate Open!<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Price: 150 Php </label>");
